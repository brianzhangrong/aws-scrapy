...
class AwsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        kind = getattr(self, 'k', None)
        urls = [
            'https://www.amazon.cn/s?k='+kind,
        ]
        for url in urls:
            print('==============begin scrawl:',url)
            yield scrapy.Request(url=url, callback=self.parse, errback=self.errback_httpbin,  dont_filter=False)
    ...
    def parse(self, response):
        for i in range(2,50):    
            ...
            price_xpaths=['//*[@id="search"]/div[1]/div[2]/div/span[3]/div[2]/div[%s]/div/span/div/div/div[4]/div[1]/div/div/a/span/span[2]/span/text()'%(i),
            ...
            yield l.load_item()
        next_page = response.xpath('//*[@id="search"]/div[1]/div[2]/div/span[3]/div[2]/div[50]/span/div/div/ul/li[@class="a-last"]/a/@href').get()
        ...
        if next_page is not None:
            ...
            yield scrapy.Request(next_page, callback=self.parse,errback=self.errback_httpbin,  dont_filter=False)    
